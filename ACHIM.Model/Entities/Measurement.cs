...
namespace postgresModel
{
    ...
    /// <summary>
    /// There are no comments for postgresModel.Measurement in the schema.
    /// </summary>
    /// <KeyProperties>
    /// Id
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="postgresModel", Name="Measurement")]
    [Serializable()]
    ...
    public partial class Measurement : EntityObject    {
        ...
        public static Measurement CreateMeasurement(int id, double value, int plantId)
        {
        ...
        partial void OnGetValue(ref double value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("postgresModel", "Plant_Measurement", "Plant")]
        public Plant Plant
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Plant>("postgresModel.Plant_Measurement", "Plant").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Plant>("postgresModel.Plant_Measurement", "Plant").Value = value;
            }
        }
        ...
        public EntityReference<Plant> PlantReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Plant>("postgresModel.Plant_Measurement", "Plant");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<Plant>("postgresModel.Plant_Measurement", "Plant", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Plant>("postgresModel.Plant_Measurement", "Plant").Value = null;
                }
            }
        }
